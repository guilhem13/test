...
from app.user.services.auth_services import check_authorization
...
Create new user 
"""
def create_new_user(User: User, last_name, first_name, phone, address,email,couple,enfants,allergies,regime, commentaires, gphoto):
    """ Auth services """
    #check_authorization(user, "add_user")
...
def get_users(): 
    return UserSqlAlchemyRepository.selectAllUsers()